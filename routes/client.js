...
router.post('/renderBasket', ensureAuthenticated, function (req, res) {
    ...
    function getEintritte(orders) {
        console.log('orders sind in getEintritte ');
        console.log(orders);
        console.log('last element: to know ...:');
        ...
        for (var key in orders) {
            ...
            console.log('for loop getEintritte');
            ...
            function addToArray(eintritteOfOrder) {
                ...
                console.log(eintritte.length);
                console.log('checking if condiiton');
                console.log(order.head.orderId);
                console.log(last.head.orderId);
                console.log('<<<<<<<<<<<<<<<<<<<<<<<<<<<')
                if (order.head.orderId == last.head.orderId) {
                    console.log('if condition is furfilled..');
                    console.log('!!!!!!!!!!!!!!!!!!!!!!!!!');
                    console.log('!!!!!!!!!!!!!!!!!!!!!!!!!');
                    console.log('!!!!!!!!!!!!!!!!!!!!!!!!!');
                    console.log('!!!!!!!!!!!!!!!!!!!!!!!!!');
        ...
        // console.log('das berüchtigte array');
        // console.log('----------------------------------------------');
        // console.log('-----------------------------------------------');
        // console.log(eintritte);
    }
